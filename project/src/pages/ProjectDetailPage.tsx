    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="container max-w-[130vh] mx-auto py-12 mt-20 px-4">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {project.plans.map((plan, idx) => (
              <div key={plan.public_id} className="group cursor-pointer" onClick={() => openLightbox(idx, 'plans')}>
      ...
      <div className="grid lg:grid-cols-3 gap-12 mt-20">
        <div className="lg:col-span-2">
          ...
          <div className='font-poppins text-gray-700 leading-relaxed text-lg' dangerouslySetInnerHTML={{ __html: project.description }} />
        </div>
